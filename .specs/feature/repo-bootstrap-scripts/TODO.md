...
- [x] Implement a flexible hook system (postBranchStart, postXxxxx, etc.) that runs in order
- [x] Auto-detect npm scripts in package.json for Node projects (feat-forge:bootstrap, feat-forge:hooks:postXxxxx)
...
- [x] Ensure hooks execute in a predictable, consistent order
- [X] Support centralized bootstrap/hook configuration via package.json for Node projects
- [x] Support hook parameters via environment variables (FORGE_HOOK_*)
